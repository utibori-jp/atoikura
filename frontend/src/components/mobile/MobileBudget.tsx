  ...
  return (
    <div>
      ...
      >
        ...
        <div style={{ fontSize: 11, color: T.inkSoft, marginTop: 6, fontWeight: 500 }}>
          変動費に使える金額（今月分）
        </div>
        ...
        {tiles.map((tile) => (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 13 }}>
              ...
              <span style={{ color: T.coralDeep, fontSize: 22, fontWeight: 700, marginLeft: 2 }}>
                ›
              </span>
            </div>
          </button>
          ...
          return (
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ fontWeight: 700, fontSize: 16, width: 36 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    <span
                      style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: 15 }}
                    >
                      {yen(r.actual)}
                    </span>
