    ...
    <div>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <button
            ...
            style={{
              ...
              border: `1.5px solid ${T.hair}`,
              background: T.card,
              color: is_at_limit ? T.hair : T.inkSoft,
              fontSize: 16,
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          {has_unsaved && (
            <span style={{ fontSize: 12, color: T.mustard, fontWeight: 600 }}>
              未保存の変更があります
            </span>
          )}
          {save_message && (
            <span
              style={{
                fontSize: 12,
                color: save_message === "保存しました" ? T.sageDeep : T.coralDeep,
                fontWeight: 600,
              }}
            >
              {save_message}
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: 11, color: T.inkSoft, marginLeft: 8 }}>
                  {st_collapsed ? "▶" : "▼"}
                </span>
              </button>
              ...
              {!st_collapsed &&
                st.category_groups.map((cg) => {
                  ...
                  return (
                    <div
                      key={`${st.statement_type_id}-${cg.group_id}`}
                    ...
                    >
                      ...
                      >
                        <span style={{ fontWeight: 700, fontSize: 14, color: T.ink, flex: 1 }}>
                          {cg.group_name}
                        </span>
                        <span
                          style={{
                        ...
                        <span style={{ fontSize: 10, color: T.inkSoft, marginLeft: 8 }}>
                          {cg_collapsed ? "▶" : "▼"}
                        </span>
                      </button>
                      ...
                      {!cg_collapsed &&
                        cg.categories.map((cat) => (
                          ...
                          >
                            <span style={{ fontSize: 13, color: T.inkSoft, flex: "0 0 130px" }}>
                              {cat.category_name}
                            </span>
                            <span
                              style={{
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setMemos((prev) => ({ ...prev, [cat.category_id]: e.target.value }))
                              }
                              style={{
                                flex: 1,
